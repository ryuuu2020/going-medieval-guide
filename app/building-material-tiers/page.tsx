...
export const metadata: Metadata = {
  title: "Going Medieval Building Material Tiers | Going Medieval Guide",
  description: "Compare building materials in Going Medieval. Durability, cost, and defense stats for wood, stone, and upgraded structures.",
  keywords: ["Going Medieval", "building material tiers", "guide", "tips", "build"],
};
...
export default function Page() {
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the most important factor for building material tiers?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "How do I improve my building material tiers setup?",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "What are common mistakes with building material tiers?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Going Medieval Building Material Tiers</h1>

      <div className="prose prose-invert max-w-none">
        <p className="text-lg text-gray-300 mb-6">
          Complete guide to building material tiers in Going Medieval. Learn proven strategies, avoid common mistakes, and dominate the medieval battlefield.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-4">Understanding building material tiers</h2>
        <p>
          In Going Medieval, mastering building material tiers is essential for survival and prosperity.
        ...
        <p>
          Effective building material tiers requires careful planning and execution. Here are the most important strategies to implement:
        </p>
        <ul className="list-disc pl-6 mt-4 space-y-2">
          <li><strong>Plan Ahead:</strong> Always think several steps ahead when designing your building material tiers strategy.</li>
          <li><strong>Optimize Efficiency:</strong> Minimize waste and maximize output in every aspect of building material tiers.</li>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Data Table: building material tiers Comparison</h2>
        ...
        <p>
          Take your building material tiers to the next level with these advanced tips:
        </p>
        <ul className="list-disc pl-6 mt-4 space-y-2">
        ...
        <p>
          Avoid these common pitfalls when working with building material tiers:
        </p>
        <ul className="list-disc pl-6 mt-4 space-y-2">
        ...
        <div className="space-y-4 mt-4">
          <details className="p-4 bg-gray-800/50 rounded-lg">
            <summary className="font-semibold cursor-pointer">What is the most important factor for building material tiers?</summary>
          ...
          <details className="p-4 bg-gray-800/50 rounded-lg">
            <summary className="font-semibold cursor-pointer">How do I improve my building material tiers setup?</summary>
            <p className="mt-2 text-gray-300">
          ...
          <details className="p-4 bg-gray-800/50 rounded-lg">
            <summary className="font-semibold cursor-pointer">What are common mistakes with building material tiers?</summary>
            <p className="mt-2 text-gray-300">
        ...
        <p>
          Mastering building material tiers in Going Medieval takes time and practice, but the rewards are well worth the effort.
