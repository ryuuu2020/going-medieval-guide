        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          <div className="flex-1 lg:max-w-[65%] space-y-10">
            ...
            <section>
              ...
              <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
                Mining into a mountain is arguably the strongest base layout in Going Medieval. A well-executed mountain base gives you natural stone walls on three sides, a temperature-stable interior, and raid immunity against anything but direct wall breaching. Begin by carving a 4-tile-wide horizontal entrance corridor into the mountain face, then expand into rooms branching off the main hallway. The entrance corridor becomes your kill box — line it with spike traps, archer balconies above, and embrasures for your ranged settlers to fire through.
              </p>
              <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
                The biggest advantage of a mountain base is thermal stability. Rooms carved 3+ tiles deep into rock maintain 8-12&deg;C year-round regardless of surface temperature, eliminating the need for braziers in winter and keeping food stockpiles cold in summer. Underground bases also make raiders path through predictable chokepoints — a single well-trapped 15-tile corridor can defeat raids that would overrun surface walls. The trade-off is significant labor: mining rooms is slow, requiring dedicated miners with high skill, and ventilation shafts must be dug to prevent stale air mood penalties for settlers working deep underground.
              </p>
