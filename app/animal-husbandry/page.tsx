        ...
        <div className="flex-1 lg:max-w-[65%] space-y-10">
          <section>
            ...
            <p className="drop-cap font-serif text-base text-ink-light leading-relaxed">
              Animals are a vital component of a thriving colony in Going Medieval. Livestock such as cows, goats, sheep, and chickens provide a renewable source of milk, wool, eggs, and meat. Donkeys (asses) serve as invaluable pack animals for hauling heavy loads, while dogs offer hauling and guard utility and cats handle vermin control. Wild animals — including boars, deer, wolves, and foxes — can be tamed and penned for meat and leather. Understanding taming mechanics, pen size requirements, feeding needs, and breeding rates is essential to building a sustainable animal economy. This guide covers all animal types, their care requirements, and the optimal strategies for integrating them into your colony. Data below is verified against the official Going Medieval Wiki (goingmedieval.fandom.com) as of June 2026.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
              Going Medieval features several animal species, each with distinct resource yields, space requirements, and utility. Understanding their differences is key to deciding which animals to prioritize for your colony.
            </p>
            <table className="parchment-table">
              ...
              <tbody>
                ...
                <tr><td className="font-semibold">Sheep</td><td>Hay, Grass</td><td>Wool (seasonal), Milk, Mutton (slaughter), Leather</td><td>10 tiles</td><td className="text-gold font-semibold">★★★★☆</td></tr>
                <tr><td className="font-semibold">Ass (Donkey)</td><td>Hay, Grass</td><td>Hauls heavy loads (pack animal), Leather (slaughter)</td><td>12 tiles</td><td className="text-gold font-semibold">★★★★★</td></tr>
                <tr><td className="font-semibold">Boar</td><td>Hay, Grass, Food scraps</td><td>Meat (slaughter), Leather</td><td>10 tiles</td><td className="text-gold font-semibold">★★★☆☆</td></tr>
                <tr><td className="font-semibold">Chicken</td><td>Seeds, Grain</td><td>Eggs (daily), Meat (slaughter)</td><td>4 tiles</td><td className="text-gold font-semibold">★★★☆☆</td></tr>
          ...
          <section>
            ...
            <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
              Key taming rules: Cows, goats, sheep, donkeys (asses), and dogs arrive via merchant caravans or events as already-tamed domestic animals. Wild animals that can be tamed include boars, hares, deer, foxes, rats, wolves, mallards, polecats, and pheasants — these require an active taming attempt by a settler with Animal Handling skill. Chickens and cats are typically acquired from merchants. Wolves are a separate wild species and do NOT become dogs when tamed. Once tamed, animals remain permanently domesticated and will not revert to the wild.
            </p>
          ...
          <section>
            ...
            <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
              All grazing animals (cows, goats, sheep, donkeys) can feed on grass within their pen — no additional food required as long as the pen contains grass tiles. During winter when grass stops growing, you must supply hay stored in a stockpile within the pen or a nearby animal feeder. Boars are omnivorous and eat food scraps in addition to hay, making them excellent waste-disposal units. Chickens require seeds or grain, which competes directly with crop planting reserves.
            </p>
          ...
          <section>
            ...
            <div className="space-y-3">
              <div className="journal-card p-4">
                ...
                <p className="font-serif text-sm text-ink-light mt-1">Largest space requirement. Produces the most valuable daily resource (milk). Plan a 6×4 pen per cow as the bare minimum — 8×6 is comfortable for breeding pairs.</p>
              </div>
              <div className="journal-card p-4">
                <h4 className="font-display text-base font-semibold text-ink">Goat: 8 tiles | Sheep: 10 tiles | Donkey: 12 tiles</h4>
                <p className="font-serif text-sm text-ink-light mt-1">Goats are the most space-efficient milk source. Sheep need slightly more room but provide wool for tailoring. Donkeys (asses) are the best pack animals with 100-180 carry capacity — they can haul heavy loads, dramatically reducing settler labor for transporting materials. All three can share a combined pen if sized appropriately.</p>
              </div>
              <div className="journal-card p-4">
                <h4 className="font-display text-base font-semibold text-ink">Boar: 10 tiles | Chicken: 4 tiles</h4>
                <p className="font-serif text-sm text-ink-light mt-1">Boars are compact meat producers that also eat food scraps. Chickens need the least space — a 2×2 coop can house a chicken. Stack chicken coops vertically (multi-floor) to maximize egg production per footprint.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="font-serif text-base text-ink-light leading-relaxed mb-4">
              Animals breed automatically when a male and female of the same species occupy the same pen. Breeding speed depends on animal type: chickens breed fastest (every 3-5 days), boars and goats are moderate (every 7-10 days), cows and sheep are slowest (every 12-15 days). Well-fed, spacious, and healthy animals breed faster. Animals that are malnourished, cramped, or sick will not breed.
            </p>
            <p className="font-serif text-base text-ink-light leading-relaxed">
          ...
          <section>
            ...
            <table className="parchment-table">
              ...
              <tbody>
                ...
                <tr><td>Meat</td><td>Boar, Chicken, Cow, Goat, Sheep</td><td>On slaughter</td><td>Food, smoked meat</td><td>Smokehouse preserves 3x longer</td></tr>
              </tbody>
            </table>
          ...
          <section>
            ...
            <p className="font-serif text-base text-ink-light leading-relaxed">
              Dogs arrive as domestic animals via merchant caravans or events — they do NOT come from taming wolves (wolves remain a separate wild species). Once in your colony, dogs can be trained for hauling, hunting, and guarding. A colony with 4-6 dogs can effectively eliminate the need for dedicated hauler settlers, dramatically improving overall productivity. Keep dogs well-fed and they will repay you tenfold in labor savings.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="faq-item">
              <details>
                ...
                <p>Recommended herd for 8 settlers: 2 cows (for milk), 1 bull, 1-2 donkeys (for hauling), 3-4 sheep (for wool), 3-4 chickens (for eggs), 2 boars (for meat), and 3-4 dogs (for hauling/guard). This provides a steady supply of animal products without over-investing in feed. Scale up proportionally for larger colonies.</p>
              </details>
            </div>
          </section>
        </div>
        ...
        <aside className="lg:w-[35%] space-y-8 shrink-0">
          <div className="field-sidebar-block">
            ...
            <div className="space-y-2 font-serif text-sm text-ink-light">
              <div className="flex justify-between"><span>S-Tier</span><span className="text-gold">Dog, Cow, Donkey</span></div>
              <div className="flex justify-between"><span>A-Tier</span><span className="text-ink-light">Sheep, Goat</span></div>
              <div className="flex justify-between"><span>B-Tier</span><span className="text-ink-muted">Chicken, Boar</span></div>
          ...
          <p className="font-serif text-xs text-ink-muted italic text-center mt-8">
